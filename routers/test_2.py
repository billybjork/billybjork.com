...
def _load_test_3_projects() -> list[dict]:
    """Load projects that currently have RGBD sprite assets for /test-3."""
    projects = []
    for sprite_id, project_slug in TEST_3_SPRITE_SLUG_MAP:
...
async def test_3_page(request: Request):
    ...
    return templates.TemplateResponse(
        ...
        {
            "request": request,
            "projects": _load_test_3_projects(),
